...
String data2;
const String data1 = "https://script.google.com/macros/s/AKfycbxci_6tUDCwJOtbQSbmKw3pUCtyjdSDtsk0YAbsmwngwBl1vs2LFktAjTkjVfn3-81eMw/exec?roll=";
...
void setup()
{
 ...
 WiFiMulti.addAP("Motorola Edge 20","peekaboo");
